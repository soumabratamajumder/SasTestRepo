                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                   ...
                                   <csrf:form  id="login_frm" method="post" action="login_slvt"  autocomplete="nope">
                        ...
                        return false;
                                     ...
                                     <div class="form-inline">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <img id="captcha" src="<%=conpath%>/Cap_Image" alt="" align="left">
                                            </div>
                                        ...
                                        <div class="text-center">
                                         <!--<input class="btn btn-primary btn-block" type="submit" value="Submit"/>-->
                                            <!-- <button type="submit" class="btn btn-primary btn-block">Sign me in</button> -->
                                             <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="signin" onclick="comHashsha('<%=ran%>');">Sign in</button>
                                        </div>
                                   </csrf:form>
